...
import ActionTableauConsulter from 'composants/bouton/actionMetier/ActionTableauConsulter';
import ActionTableauModifier from 'composants/bouton/actionMetier/ActionTableauModifier';
import ActionTableauSupprimer from 'composants/bouton/actionMetier/ActionTableauSupprimer';
import OptionNon from 'composants/widget/OptionNon';
import OptionOui from 'composants/widget/OptionOui';
        ...
        React.Children.forEach(children, (c, index) => {
            if (_.nonNul(c)) {
                ...
                if (c.props.tc === 'date') {
                    ...
                    c_attributs.render = (text) => {
                        return _.nonNul(text) && text ? <OptionOui /> : <OptionNon />;
                    };
